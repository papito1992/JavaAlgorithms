package JavaMaster.Interfaces.timbuchalka;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Monster monster= new Monster("shit",69,69);
...
//        loadObject(tim);
//        System.out.println(tim);
//        ISaveable playe = new Player("dok",69,6969);
//
//        saveObject(playe);
//        loadObject(playe);
...
//        for(int i=0; i<objectToSave.write().size(); i++) {
            System.out.println("Saving " + objectToSave.write() + " to storage device");
